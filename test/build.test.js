...
describe('test/build.test.js', () => {
  ...
  describe('build framework', () => {
    const cwd = path.join(__dirname, 'fixtures/base');
    const target = path.join(cwd, 'run/site');
    before(function* () {
    ...
    it.only('should generate framework version and node version', function* () {
